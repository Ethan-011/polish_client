      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          <div className={cn(
            ...
            <span className="inline-block px-3 py-1 mb-5 text-xs font-medium tracking-wider text-white uppercase bg-accent rounded-full">
          ...
          <h1 className={cn(
            ...
            <span className="text-accent">حرفه‌ای فلزات</span>
          </h1>
          ...
          <div className={cn(
            ...
            <a href="#contact" className="px-6 py-3 w-full sm:w-auto rounded-md border border-white/30 text-white font-medium hover:bg-white/10 transition-all duration-300">
              تماس با ما
            </a>
          </div>
        </div>
